...
<html>
<head>
  <title>WebRSS Creator (Create RSS For Free) : <xsl:value-of select="title"/></title>
...
<table class="main" style="margin-top:10px">
  <tr>
    <td width="240"><a href="#"><img alt="WebRSS Creator (Create RSS For Free)" src="images/logo.png" width="177" height="45" /></a></td>
    <td class="notice">
      <p class="bold">You are viewing a news feed generated by <a href="#">WebRss Creator</a> service.</p>
...
<div class="main footer">
  Powered by VTurnSpace Copyright &#169; 2014 All rights reserved.
</div>
