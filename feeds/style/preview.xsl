...
<html>
<head>
  <title>VTurn (Feed For Free) : <xsl:value-of select="title"/></title>
...
<table class="main" style="margin-top:10px">
  <tr>
    <td width="240"><a href="/"><img alt="VTurn (Feed For Free)" src="images/logo.gif" width="177" height="45" /></a></td>
    <td class="notice">
      <p class="bold">You are viewing a news feed generated by <a href="/">VTurn Feed</a> service.</p>
...
<div class="main footer">
  VTurn Feed v. 1.0. Copyright &#169; 2014 VTurn All rights reserved.
</div>
